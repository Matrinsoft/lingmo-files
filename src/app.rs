...
impl App {
    ...
    fn update_title(&mut self) -> Task<Message> {
        let window_title = match self.tab_model.text(self.tab_model.active()) {
            Some(tab_title) => format!("{tab_title} 鈥?{}", fl!("cosmic-files")),
...
impl Application for App {
    ...
    fn init(mut core: Core, flags: Self::Flags) -> (Self, Task<Self::Message>) {
        ...
        let about = About::default()
            ...
            .links([
                (fl!("repository"), "https://github.com/Matrinsoft/lingmo-files"),
                (
                    fl!("support"),
                    "https://github.com/Matrinsoft/lingmo-files/issues",
                ),
            ]);
